...
| 7 | Distribution | `rulecast doctor` (including the llm pre-flight checks plan 6 defers to it), standalone binary, release pipeline, public repository (needed by the drafting prompt's raw GitHub links), aka-agents2 dogfooding | §5 (doctor), §16, §17 | Written 2026-09-22, in three parts to execute in order: `2026-09-22-rulecast-07a-doctor.md` (doctor, 9 tasks, done 2026-09-22), `07b-ci-release.md` (README, CI, releases, 8 tasks), `07c-public-dogfood.md` (public repo and aka-agents2, 7 tasks) |
