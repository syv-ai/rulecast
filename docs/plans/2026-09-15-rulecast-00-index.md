...
|---|---|---|---|---|
| 1 | Core + CLI | Package scaffold, compile, `regex`/`path` detectors, detection runner, baseline, session, delivery, pipeline, `rulecast check` and `rulecast validate` | §3–§11, §12 (CLI), §14, §15 (compile/baseline/session) | Written, in five parts executed in order: `2026-09-15-rulecast-01a-compile.md` (tasks 1–8), `01b-detection.md` (9–14), `01c-baseline.md` (15–20), `01d-session-delivery.md` (21–27), `01e-pipeline-cli.md` (28–32) |
